...
const featuredProjects = [
  ...
  },
  {
    ...
    description: "A full-stack e-commerce app with authentication and product management.",
  ...
  {
    title: "Blog Platform",
    description: "A markdown-based blog website built with Next.js and TailwindCSS.",
  ...
  {
    title: "AI Chatbot",
    description: "An AI-powered chatbot using OpenAI API with a beautiful React frontend.",
...
const otherProjects = [
  {
    ...
    description: "Node.js CLI tool that shows weather info from OpenWeatherMap API.",
    github: "https://github.com/yourusername/weather-cli",
  },
  {
    title: "To-Do API",
    description: "A RESTful API for a task manager app using Express and MongoDB.",
    github: "https://github.com/yourusername/todo-api",
  },
  {
    title: "Typing Speed Game",
    description: "A fun typing speed test game made using vanilla JavaScript.",
